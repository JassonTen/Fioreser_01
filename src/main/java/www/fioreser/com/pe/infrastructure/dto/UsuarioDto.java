...
public class UsuarioDto {
    ...
    public UsuarioEntity usuarioDtoToUsuario(){
    ...
    public UsuarioEntity usuarioDtoToAdmin(){
        return new UsuarioEntity(null, this.getNombres(), this.getCorreo(), this.getContraseña(), this.getCelular(), this.getDireccion(), LocalDateTime.now(), UsuarioType.ADMIN);
    }
